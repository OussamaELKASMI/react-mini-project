...
export default function ReserveModal({ open, onClose, room, reservations = [], user, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 z-50">
      <div className="absolute inset-0 bg-black/40 z-0" onClick={onClose} aria-hidden="true" />

      <div className="w-full max-w-xl mx-auto absolute inset-0 flex items-end sm:items-center justify-center p-3">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button
                  ...
                  className={[
                    ...
                    canConfirm
                      ? 'bg-sec/80 text-slate-800 hover:bg-transparent border border-sec transition-all duration-200 shadow-sm'
